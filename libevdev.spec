...
Source0  : https://www.freedesktop.org/software/libevdev/libevdev-1.13.2.tar.xz
Source1  : https://www.freedesktop.org/software/libevdev/libevdev-1.13.2.tar.xz.sig
...
%setup -q -n libevdev-1.13.2
cd %{_builddir}/libevdev-1.13.2
pushd ..
cp -a libevdev-1.13.2 build32
popd
pushd ..
cp -a libevdev-1.13.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717427632
