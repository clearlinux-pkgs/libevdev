...
Source0  : https://www.freedesktop.org/software/libevdev/libevdev-1.9.902.tar.xz
Source1  : https://www.freedesktop.org/software/libevdev/libevdev-1.9.902.tar.xz.sig
...
%prep
%setup -q -n libevdev-1.9.902
cd %{_builddir}/libevdev-1.9.902
pushd ..
cp -a libevdev-1.9.902 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603214899
...
cp %{_builddir}/libevdev-1.9.902/COPYING %{buildroot}/usr/share/package-licenses/libevdev/5a9e6860301d6944285c7fe35b0c311599974bc1
cp %{_builddir}/libevdev-1.9.902/doc/style/LICENSE %{buildroot}/usr/share/package-licenses/libevdev/5a48bb048772f9029b604fbdd869d92fddae1cef
pushd ../build32/
%make_install32
