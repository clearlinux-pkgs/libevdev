...
Source0  : https://www.freedesktop.org/software/libevdev/libevdev-1.13.3.tar.xz
Source1  : https://www.freedesktop.org/software/libevdev/libevdev-1.13.3.tar.xz.sig
...
%setup -q -n libevdev-1.13.3
cd %{_builddir}/libevdev-1.13.3
pushd ..
cp -a libevdev-1.13.3 build32
popd
pushd ..
cp -a libevdev-1.13.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725375493
